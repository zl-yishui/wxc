...
class Xueye( models.Model ):
    ...
    xueye_banji = models.IntegerField( default=99, verbose_name="班级编号" )
    xueye_banji_name = models.CharField( max_length=150, blank=True, default='', verbose_name="班级名称" )
    zhaoshengjihua = models.IntegerField( default=99999999, verbose_name="招生计划" )
